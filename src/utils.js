...
const contactFormHandler = (e) => {
  ...
  contactModal.classList.remove('contact-form-notvisible');
  contactModal.classList.add('contact-form-visible');
  contactModal.classList.remove('animate-contactform-close');
  contactModal.classList.add('animate-contactform-open');
  ...
  const closeForm = (e) => {
    ...
    contactModal.classList.remove('contact-form-visible');
    contactModal.classList.remove('animate-contactform-open');
    contactModal.classList.add('animate-contactform-close');
